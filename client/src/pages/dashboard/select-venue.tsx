    ...
    <div className="min-h-screen bg-muted/30 p-4">
      <div className="w-full max-w-2xl mx-auto pt-8">
        <div className="text-center mb-8">
          <img src={indexFlowLogo} alt="indexFlow Workspace Dashboard" className="h-16 mx-auto mb-4" />
                  ...
                  <div className="flex items-center gap-3 min-w-0 flex-1">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <Badge variant="secondary" className="text-xs shrink-0">{getWorkspaceTypeLabel(ws.type)}</Badge>
                      </div>
                      {(ws.address || ws.city) && (
                        <p className="text-xs text-muted-foreground mt-0.5 truncate flex items-center gap-1">
                          <MapPin className="w-3 h-3 shrink-0" />
                          {[ws.address, ws.city, ws.state].filter(Boolean).join(", ")}
                        </p>
                      )}
                    </div>
                  </div>
