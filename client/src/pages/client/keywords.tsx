...
import { ArrowUp, ArrowDown, Minus, TrendingUp, Target, Hash } from "lucide-react";
          ...
          <Card key={m.label} className="p-4">
            <div className="flex items-center justify-between gap-2">
              <div>
                ...
                <p className="text-xl font-bold mt-1" data-testid={`text-client-kw-${m.label.toLowerCase().replace(/[\s.]+/g, '-')}`}>{m.value}</p>
              </div>
